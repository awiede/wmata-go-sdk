...
var testData = map[string][]testResponseData{
	"/Rail.svc/json/jLines": {
		testResponseData{
			jsonPath:     "/Rail.svc/json/jLines",
			xmlPath:      "/Rail.svc/Lines",
			rawQuery:     "",
	...
	"/Rail.svc/json/jStationParking": {
		{
			jsonPath:     "/Rail.svc/json/jStationParking",
			xmlPath:      "/Rail.svc/StationParking",
	...
	"/Rail.svc/json/jPath": {
		{
			jsonPath:     "/Rail.svc/json/jPath",
			xmlPath:      "/Rail.svc/Path",
	...
	"/Rail.svc/json/jStationEntrances": {
		{
			jsonPath: "/Rail.svc/json/jStationEntrances",
			xmlPath:  "/Rail.svc/StationEntrances",
	...
	"/Rail.svc/json/jStationInfo": {
		{
			jsonPath:     "/Rail.svc/json/jStationInfo",
			xmlPath:      "/Rail.svc/StationInfo",
	...
	"/Rail.svc/json/jStations": {
		{
			jsonPath:     "/Rail.svc/json/jStations",
			xmlPath:      "/Rail.svc/Stations",
	...
	"/Rail.svc/json/jStationTimes": {
		{
			jsonPath:     "/Rail.svc/json/jStationTimes",
			xmlPath:      "/Rail.svc/StationTimes",
			rawQuery:     "StationCode=F01",
			stringParam1: "F01",
	...
	"/Rail.svc/json/jSrcStationToDstStationInfo": {
		{
			jsonPath:     "/Rail.svc/json/jSrcStationToDstStationInfo",
			xmlPath:      "/Rail.svc/SrcStationToDstStationInfo",
